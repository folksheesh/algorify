        ...
        <main class="main-content">
            <header class="main-header">
                <div class="search-container">
                    <input type="search" class="search-input" placeholder="Cari data analitik..." aria-label="Cari data" />
            ...
            <section class="hero-banner">
                <div class="hero-content">
                    ...
                    <p class="hero-description">Pantau dan analisis performa pelatihan TIK</p>
                </div>
            </section>
            <section class="stats-section">
                <div style="padding: 2rem; background: white; border-radius: 12px; margin-top: 2rem;">
                    ...
                    <p style="color: #64748B;">Konten untuk halaman Analitik akan segera ditambahkan.</p>
                </div>
            </section>
        </main>
    </div>
