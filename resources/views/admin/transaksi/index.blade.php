        ...
        <main class="main-content">
            <header class="main-header">
                <div class="search-container">
                    <input type="search" class="search-input" placeholder="Cari transaksi..." aria-label="Cari transaksi" />
            ...
            <section class="stats-section">
                <div style="padding: 2rem; background: white; border-radius: 12px; margin-top: 2rem;">
                    ...
                    <p style="color: #64748B;">Konten untuk halaman Transaksi akan segera ditambahkan.</p>
                </div>
            </section>
        </main>
    </div>
