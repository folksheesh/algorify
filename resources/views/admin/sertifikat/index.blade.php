        ...
        <main class="main-content">
            <header class="main-header">
                <div class="search-container">
                    <input type="search" class="search-input" placeholder="Cari sertifikat..." aria-label="Cari sertifikat" />
            ...
            <section class="hero-banner">
                <div class="hero-content">
                    <h1 class="hero-title">Sertifikat</h1>
                    <p class="hero-description">Kelola dan pantau sertifikat pelatihan TIK</p>
                </div>
            </section>
            <section class="stats-section">
                <div style="padding: 2rem; background: white; border-radius: 12px; margin-top: 2rem;">
                    ...
                    <p style="color: #64748B;">Konten untuk halaman Sertifikat akan segera ditambahkan.</p>
                </div>
            </section>
        </main>
    </div>
