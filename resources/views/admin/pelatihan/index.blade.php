...
@section('title', 'Data Pelatihan - Algorify')
        ...
        <main class="main-content">
            <header class="main-header">
                <div class="search-container">
                    <input type="search" class="search-input" placeholder="Cari pelatihan..." aria-label="Cari pelatihan" />
            ...
            <section class="hero-banner">
                <div class="hero-content">
                    <h1 class="hero-title">Data Pelatihan</h1>
                    <p class="hero-description">Kelola dan pantau data pelatihan TIK</p>
                </div>
            </section>
            <section class="stats-section">
                <div style="padding: 2rem; background: white; border-radius: 12px; margin-top: 2rem;">
                    ...
                    <p style="color: #64748B;">Konten untuk halaman Data Pelatihan akan segera ditambahkan.</p>
                </div>
            </section>
        </main>
    </div>
