        ...
        <main class="main-content">
            <header class="main-header">
                <div class="search-container">
                    <input type="search" class="search-input" placeholder="Cari pengajar..." aria-label="Cari pengajar" />
            ...
            <section class="hero-banner">
                <div class="hero-content">
                    <h1 class="hero-title">Data Pengajar</h1>
                    <p class="hero-description">Kelola dan pantau data pengajar pelatihan TIK</p>
                </div>
            </section>
            <section class="stats-section">
                <div style="padding: 2rem; background: white; border-radius: 12px; margin-top: 2rem;">
                    ...
                    <p style="color: #64748B;">Konten untuk halaman Data Pengajar akan segera ditambahkan.</p>
                </div>
            </section>
        </main>
    </div>
