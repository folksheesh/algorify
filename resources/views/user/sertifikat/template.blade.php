...
.logo span { font-size: 20px; font-weight: bold; color: #3A6DFF; vertical-align: middle; margin-left: 8px; }
.title { font-size: 28px; color: #3A6DFF; font-style: italic; font-weight: 300; margin: 15px 0 5px; }
...
.course { font-size: 18px; font-weight: bold; color: #3A6DFF; margin: 8px 0 10px; }
...
.info-box .val.score { color: #3A6DFF; }
...
.badge { width: 40px; height: 40px; border: 2px solid #3A6DFF; border-radius: 50%; background: #F0F0FF; margin: 0 auto 5px; }
.badge-text { font-size: 9px; color: #3A6DFF; }
.dir { font-size: 11px; font-weight: bold; color: #3A6DFF; }
.dir-title { font-size: 8px; color: #3A6DFF; text-decoration: underline; }
.dir-loc { font-size: 8px; color: #999; }
.verify { font-size: 8px; color: #999; margin-top: 10px; padding-top: 10px; border-top: 1px solid #eee; }
.verify a { color: #3A6DFF; text-decoration: none; }
</style>
</head>
<body>
<div class="cert">
