            ...
            @if (Auth::user()->hasAnyRole(['admin', 'super admin']))
                    ...
                    <a href="#" class="nav-link" data-title="Data Pelatihan"
                        ...
                        <svg class="nav-icon" width="20" height="20" viewBox="0 0 20 20" fill="none"
                            ...
                            <path
                                ...
                                stroke="currentColor" stroke-width="1.5" fill="none" />
                            <path d="M8 10H16M8 14H12" stroke="currentColor" stroke-width="1.5"
                ...
                <li class="nav-item {{ request()->routeIs('admin.transaksi.index') ? 'active' : '' }}">
                    <a href="{{ route('admin.transaksi.index') }}" class="nav-link" data-title="Transaksi">
                        <svg class="nav-icon" width="20" height="20" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M3 10h18M3 10a2 2 0 01-2-2V6a2 2 0 012-2h18a2 2 0 012 2v2a2 2 0 01-2 2M3 10a2 2 0 00-2 2v2a2 2 0 002 2h18a2 2 0 002-2v-2a2 2 0 00-2-2"
                                stroke="currentColor" stroke-width="1.5" fill="none" />
                        </svg>
                ...
                <li class="nav-item {{ request()->routeIs('admin.sertifikat.index') ? 'active' : '' }}">
                    <a href="{{ route('admin.sertifikat.index') }}" class="nav-link" data-title="Sertifikat">
                        <svg class="nav-icon" width="20" height="20" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect x="4" y="4" width="12" height="13" rx="1" stroke="currentColor"
                                stroke-width="1.5" fill="none" />
            ...
            @else
                ...
                <li
                    ...
                    <a href="{{ route('user.pelatihan-saya.index') }}" class="nav-link" data-title="Pelatihan Saya">
                        <svg class="nav-icon" width="20" height="20" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect x="4" y="3" width="12" height="14" rx="1" stroke="currentColor"
                                stroke-width="1.5" fill="none" />
                ...
                <li class="nav-item {{ request()->routeIs('user.sertifikat.index') ? 'active' : '' }}">
                    <a href="{{ route('user.sertifikat.index') }}" class="nav-link"
                        data-title="Dapatkan Sertifikat">
                        <svg class="nav-icon" width="20" height="20" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect x="4" y="4" width="12" height="13" rx="1" stroke="currentColor"
                                stroke-width="1.5" fill="none" />
...
<style>
   ...
   ============================================ */
    ...
    .sidebar-edge-toggle {
        position: fixed;
        left: 268px;
        /* sidebar width (280px) - half button width */
        top: 50%;
    ...
    .sidebar.collapsed~.sidebar-edge-toggle {
        left: 60px;
        /* collapsed width (72px) - half button width */
    }
