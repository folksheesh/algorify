                ...
                <div class="course-detail-wrapper">
                    ...
                    <div class="course-main-section">
                        ...
                        <div class="course-image-container">
                            @php
                                $thumbnailUrl = resolve_thumbnail_url($kursus->thumbnail, asset('images/default-course.jpg'));
                            @endphp
                    ...
                    <div class="course-info-row">
                        ...
                        <div class="course-info-item">
                            ...
                            <span class="info-description">Dapatkan wawasan mendalam tentang fundamental {{ strtolower($kursus->judul) }}.</span>
                        </div>
                    ...
                    <div class="instructor-section">
                        ...
                        <div class="instructor-bio">Instruktur berpengalaman dengan keahlian di bidang {{ strtolower($kursus->judul) }} yang siap membimbing Anda mencapai tujuan pembelajaran.</div>
                    </div>
