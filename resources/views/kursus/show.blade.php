            ...
            <main class="main-content" style="background: #f8f9fa; min-height: 100vh;">
                <div class="course-detail-wrapper">
                    ...
                    <div class="instructor-section">
                        ...
                        <div class="instructor-name">{{ $kursus->user->name ?? 'Nama Instruktur' }}</div>
                        <div class="instructor-role">{{ $kursus->user->profesi ?? '-' }}</div>
                        <div class="instructor-bio">{{ $kursus->user->bio ?? '' }}</div>
                    </div>
