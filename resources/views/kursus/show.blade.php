                    ...
                    <div class="course-info-row">
                        ...
                        <div class="course-info-item">
                            <div class="info-header">
                                ...
                                <span class="info-title">Tipe: {{ ucfirst($kursus->tipe ?? 'online') }}</span>
                            </div>
                            <span class="info-description">{{ $kursus->tipe === 'offline' ? 'Kursus dilaksanakan secara tatap muka' : ($kursus->tipe === 'hybrid' ? 'Kombinasi online dan tatap muka' : 'Belajar sesuai kecepatan Anda sendiri') }}</span>
                        </div>
                    </div>
