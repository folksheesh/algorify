        ...
        'Mengembangkan portfolio dan kemampuan profesional',
                    ...
                    <div class="course-highlight-row">
                        <div class="instructor-section highlight-card">
                            ...
                            <div class="instructor-bio">{{ $kursus->pengajar->pengalaman ?? 'Instruktur berpengalaman dengan keahlian di bidang ' . strtolower($kursus->judul) . ' yang siap membimbing Anda mencapai tujuan pembelajaran.' }}</div>
                        </div>
